...
.org 1<<3; NOP
	-  \ - \ -  \ TSA   \  -  \  INT  \  LAD  \ START \  - ; 0000 0010 0000 0000

.org 2<<3; R1 = R1 + 1
	- \ - \ - \ INC \ - \ INT \ LAD \ START \ RFMUX ; 
.org 3<<3; R3 = R1 | R2
	- \ - \ - \ OR \ - \ INT \ LAD \ START \ RFMUX ; 0000 0110 0101 0011
	
.org 4<<3; Load [128], R5
	-  \ - \ -    \ -   \ - \ INT \ NEXT \ 128   \ LDMAR | DMUX ; 0000 1000 0000 0101   
	-  \ - \ -    \ -   \ - \ INT \ NEXT \   -   \  READ  ;
	-  \ - \  -   \ TSA \ - \ INT \ LAD \  START \  FETCH | RFMUX ;
