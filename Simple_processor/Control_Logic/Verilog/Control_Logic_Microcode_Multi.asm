...
START:
	...
	-  \ -  \ R2   \ TSA \  -  \ -   \ NEXT \ 0    \ DMUX ;
	-  \ -  \ R4   \ TSA \  -  \ -   \ NEXT \ 0    \ DMUX ;
	R1 \ R2 \ R3   \ SUB \UPALL\ -   \ NEXT \ -    \ - ;
	-  \ -  \ NONE \ TSA \  -  \ INT \ LC   \ L1   \ - ;
	R4 \ R1 \ R4   \ ADD \UPALL\ INT \ LAD  \ MULT \ - ;
L1:	-  \ -  \ NONE \ TSA \  -  \ INT \ LNZ  \ L2   \ - ;
	R4 \ -  \ R4   \ INC \UPZS \  -  \ LAD  \ MULT \ - ;
L2:	R4 \ R2 \ R4   \ ADD \UPALL\  -  \ LAD \ MULT \ - ;
MULT:	-  \ -  \ R4   \ TSA \  -  \ -   \ NEXT \ 0    \ DMUX ;
		R4 \ R2 \ R5   \ ADD \UPALL\ INT \ NEXT  \ - \ - ;
		-  \ -  \ NONE \ TSA \  -  \ INT \ LZ  \ DONE \ - ; Multiplied by 0
MULTREP:R1 \ R4 \ R4   \ ADD \UPALL\ INT \ NEXT  \ - \ - ;
		R2 \ -  \ R2   \ DEC \UPZS \  -  \ NEXT  \ - \ - ;
		-  \ -  \ NONE \ TSA \  -  \ INT \ LNZ  \ MULTREP \ - ; Multiplication is finished if R2 == 0
DONE:	R4 \ -  \ NONE \ TSA \  -  \ INT \ LAD  \ START\ - ;
